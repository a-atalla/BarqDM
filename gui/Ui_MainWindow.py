...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tblActive.setAlternatingRowColors(True)
        ...
        self.tblActive.setGridStyle(QtCore.Qt.DotLine)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/images/icons/qt-logo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAboutQt.setIcon(icon10)
        self.actionAboutQt.setObjectName("actionAboutQt")
        self.actionDownloadLimit = QtGui.QAction(MainWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/images/icons/go-down.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDownloadLimit.setIcon(icon11)
        self.actionDownloadLimit.setObjectName("actionDownloadLimit")
        self.actionCleanList = QtGui.QAction(MainWindow)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/images/icons/edit-clear.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCleanList.setIcon(icon12)
        self.actionCleanList.setObjectName("actionCleanList")
        self.actionOpenFolder = QtGui.QAction(MainWindow)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/images/icons/folder-blue.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOpenFolder.setIcon(icon13)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/images/icons/system-reboot.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionResumeError.setIcon(icon14)
